...
|--|--|
| ```SQL 
INSERT  INTO  users (user_id, age, NAME)  
VALUES  ("f62255a8259f", 30, “peter”)``` | ```js
pnp.sp.web.lists.getByTitle("users").items**.add**({user_id: "f62255a8259f", age: 30, name: "Peter"}).then(function (itemAdicionado) { })
``` |
